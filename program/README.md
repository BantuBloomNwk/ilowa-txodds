...
- `instructions/resolve_market_via_txline.rs`: the trustless path. It CPIs into
  TxLINE's `validate_stat` with the three-stage Merkle proof, and the returned boolean
  sets the market outcome. No admin key decides the result.
